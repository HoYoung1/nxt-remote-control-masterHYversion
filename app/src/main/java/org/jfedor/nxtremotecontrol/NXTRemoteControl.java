...
public class NXTRemoteControl extends Activity implements OnSharedPreferenceChangeListener {
    ...
    public class Uping implements OnTouchListener {
    ...
    private class UpDirectionButtonOnTouchListener implements OnTouchListener {
        ...
        public boolean onTouch(View v, MotionEvent event) {
            ...
            if ((action == MotionEvent.ACTION_DOWN) || (action == MotionEvent.ACTION_MOVE)) {
                mNXTTalker.motors3((byte) 0, (byte) 0, (byte) -50, mRegulateSpeed, mSynchronizeMotors);

                //mNXTTalker.motor(3,(byte)80, mRegulateSpeed, mSynchronizeMotors);
    ...
    } //End of DirectionButtonOnTouchListener

    private class DownDirectionButtonOnTouchListener implements OnTouchListener {
    ...
    private class AllDirectionButtonOnTouchListener implements OnTouchListener {
        ...
        public boolean onTouch(View v, MotionEvent event) {
            ...
            if ((action == MotionEvent.ACTION_DOWN) || (action == MotionEvent.ACTION_MOVE)) {
                Log.d("HY","testcomecount");
                mNXTTalker.motors3((byte) -80, (byte) -80, (byte) -50, mRegulateSpeed, mSynchronizeMotors);
    ...
    private class AllDownDirectionButtonOnTouchListener implements OnTouchListener {
        ...
        public boolean onTouch(View v, MotionEvent event) {
            ...
            if ((action == MotionEvent.ACTION_DOWN) || (action == MotionEvent.ACTION_MOVE)) {
                Log.d("HY","testcomecount");
                mNXTTalker.motors3((byte) 80, (byte) 80, (byte) 30, mRegulateSpeed, mSynchronizeMotors);
        ...
        public boolean onTouch(View v, MotionEvent event) {
            ...
            if ((action == MotionEvent.ACTION_DOWN) || (action == MotionEvent.ACTION_MOVE)) {
                ...
                if (!mReverseLR) {
                    ...
                    Log.d("HY", "l, r, a, :"+ l +" "+ r+" "+ a);
                    Log.d("HY", "mRegulateSpeed, mSynchronizeMotors"+mRegulateSpeed+" "+ mSynchronizeMotors);
                } else {
    ...
    private void setupUI() {
        if (mControlsMode == MODE_BUTTONS) {
            ...
            updateMenu(R.id.menuitem_buttons);
             ...
             class Uping implements OnTouchListener {
                public boolean onTouch(View v, MotionEvent event)
                {
                   /*
                   mNXTTalker.motors3((byte)0, (byte)0, (byte)-80, mRegulateSpeed, mSynchronizeMotors);
                   */
                   mNXTTalker.motor(3,(byte)-80, mRegulateSpeed, mSynchronizeMotors);
                    return true;
                }
             ...
             class Downing implements OnTouchListener{
                public boolean onTouch(View v, MotionEvent event)
                {
                    /*
                    mNXTTalker.motors3((byte)0, (byte)0, (byte)-80, mRegulateSpeed, mSynchronizeMotors);
            ...
            Button buttonGoingUp = (Button) findViewById(R.id.button6);
            Button buttonGoingDown = (Button) findViewById(R.id.button5);
            Button buttonAllgo = (Button) findViewById(R.id.button7);

            buttonGoingUp.setOnTouchListener(new UpDirectionButtonOnTouchListener());
            buttonGoingDown.setOnTouchListener(new DownDirectionButtonOnTouchListener());
            buttonAllgo.setOnTouchListener(new AllDirectionButtonOnTouchListener());
            buttonDown.setOnTouchListener(new AllDownDirectionButtonOnTouchListener());
